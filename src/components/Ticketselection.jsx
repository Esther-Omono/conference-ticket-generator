    ...
    <div className='p-4 sm:p-6 bg-[#08252b] rounded-2xl border border-[#0e464e] my-4 sm:my-7'>
      <div className='border border-[#0e464e] rounded-2xl p-4 sm:p-6 min-h-[200px] bg-[radial-gradient(103.64%_57.39%_at_14.02%_32.06%,rgba(36,160,181,0.2)_0%,rgba(36,160,181,0)_100%),rgba(10,12,17,0.1)]'>
        ...
        <div className='flex flex-col gap-4'>
          ...
          <p className='text-center text-neutral-50 text-sm sm:text-base font-normal leading-normal'>
          ...
          <div className='flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4 text-center'>
            <p className='text-neutral-50 text-sm sm:text-base font-normal leading-normal'>
              📍 Lagos
            </p>
            <p className='hidden sm:block text-neutral-50 text-base font-normal leading-normal'>
              | |
            </p>
            <p className='text-neutral-50 text-sm sm:text-base font-normal leading-normal'>
      ...
      <div className='mt-5 flex flex-col gap-2 w-full'>
        ...
        <select className='w-full p-3 rounded-xl border text-white border-[#07363e] bg-transparent text-sm sm:text-base'>
